...
class UserProfilesControllerTest < ActionController::TestCase
  ...
  test "should create user_profile" do
    assert_difference('UserProfile.count') do
      post :create, user_profile: { avatar: @user_profile.avatar, gender: @user_profile.gender, location: @user_profile.location, mobile: @user_profile.mobile, nickname: @user_profile.nickname }
    end
  ...
  test "should update user_profile" do
    put :update, id: @user_profile, user_profile: { avatar: @user_profile.avatar, gender: @user_profile.gender, location: @user_profile.location, mobile: @user_profile.mobile, nickname: @user_profile.nickname }
    assert_redirected_to user_profile_path(assigns(:user_profile))
  end
