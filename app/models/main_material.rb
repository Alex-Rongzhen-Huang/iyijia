...
class MainMaterial < ActiveRecord::Base
  ...
  attr_accessible :main_material_name_sub_category_id

  validates :name,:specifications, :main_material_name_id,:package_type,:main_material_brand_id, :presence => true
